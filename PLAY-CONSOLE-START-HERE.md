# FUJARA 0.5.1 — start w Google Play od zera
...
## 1. Wgraj wersję 0.5.1 do GitHuba
...
W aplikacji 0.5.1 jest przycisk `Pokaż demo obliczeń`. Dzięki temu recenzent może zobaczyć sposób prezentacji wyniku bez konta kuriera i bez oczekiwania na prawdziwą ofertę.
